...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220105_nervergiveup_7c19332f074429408551_20220105083833_archive.zip';
	const ARCHIVE_SIZE		 = '44580648';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '7c19332-05083833';
    const SECONDARY_PACKAGE_HASH = 'b2dbbe8-05083833';
	const VERSION			 = '1.4.3';
